...
# get mean and max abundance for each Site/Year/Taxon
...
# site_code, plot, year, taxon is a unique identifier in our data
modeling_data_plot <- nutnetdf_allspp %>% 
...
# try a mixed effects model
multiyear_model_plot <- glmer(lost ~ rel_rank_lag  + (1|site_code/plot) + (1|Taxon),
...
# add a column in the dataframe for predictions
multiyear_data_with_fitted_values_plot <- modelr::add_predictions(data = modeling_data_plot, 
                                                 model = multiyear_model_plot, 
                                                 type = "response")
